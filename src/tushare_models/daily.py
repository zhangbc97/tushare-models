...
class Daily(Base):
    ...
    __api_title__: ClassVar[str] = "历史日线"
    __api_info_title__: ClassVar[str] = "历史日线"
...
try:
    ...
    setattr(Daily.__table__, "engine", engines.ReplacingMergeTree(order_by=Daily.__primary_key__))
except Exception:
    pass
...
try:
    ...
    Daily.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(Daily.__primary_key__),
            "order_by": ",".join(Daily.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    Daily.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": Daily.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    Daily.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": Daily.__primary_key__,
        }
    )
except Exception:
    pass
