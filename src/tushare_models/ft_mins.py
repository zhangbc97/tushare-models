...
class FtMins(Base):
    ...
    __api_info_title__: ClassVar[str] = "历史分钟行情"
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {
        ...
        "freq": {"type": "String", "required": False, "description": "分钟频度"},
    ...
    oi = Column("oi", Float, nullable=True, comment="")
...
try:
    ...
    setattr(FtMins.__table__, "engine", engines.ReplacingMergeTree(order_by=FtMins.__primary_key__))
except Exception:
    pass
...
try:
    ...
    FtMins.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(FtMins.__primary_key__),
            "order_by": ",".join(FtMins.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    FtMins.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": FtMins.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    FtMins.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": FtMins.__primary_key__,
        }
    )
except Exception:
    pass
