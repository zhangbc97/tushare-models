...
class HkMins(Base):
    ...
    __api_info_title__: ClassVar[str] = "港股分钟行情"
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {
        "ts_code": {"type": "String", "required": False, "description": "ts_code"},
        ...
        "test": {"type": "String", "required": False, "description": ""},
...
try:
    ...
    setattr(HkMins.__table__, "engine", engines.ReplacingMergeTree(order_by=HkMins.__primary_key__))
except Exception:
    pass
...
try:
    ...
    HkMins.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(HkMins.__primary_key__),
            "order_by": ",".join(HkMins.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    HkMins.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": HkMins.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    HkMins.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": HkMins.__primary_key__,
        }
    )
except Exception:
    pass
