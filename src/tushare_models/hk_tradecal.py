...
try:
    ...
    setattr(HkTradecal.__table__, "engine", engines.ReplacingMergeTree(order_by=HkTradecal.__primary_key__))
except Exception:
    pass
...
try:
    ...
    HkTradecal.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(HkTradecal.__primary_key__),
            "order_by": ",".join(HkTradecal.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    HkTradecal.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": HkTradecal.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    HkTradecal.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": HkTradecal.__primary_key__,
        }
    )
except Exception:
    pass
