...
class IndexDaily(Base):
    ...
    __api_info_title__: ClassVar[str] = "南华期货指数行情"
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {
        "ts_code": {"type": "String", "required": True, "description": "指数代码"},
...
try:
    ...
    setattr(IndexDaily.__table__, "engine", engines.ReplacingMergeTree(order_by=IndexDaily.__primary_key__))
except Exception:
    pass
...
try:
    ...
    IndexDaily.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(IndexDaily.__primary_key__),
            "order_by": ",".join(IndexDaily.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    IndexDaily.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": IndexDaily.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    IndexDaily.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": IndexDaily.__primary_key__,
        }
    )
except Exception:
    pass
