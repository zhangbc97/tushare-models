...
class LimitStep(Base):
    ...
    __api_info_title__: ClassVar[str] = "涨停股票连板天梯"
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {
        ...
        "nums": {"type": "String", "required": False, "description": "连板次数"},
    ...
    nums = Column("nums", String(), nullable=True, comment="连板次数")
...
try:
    ...
    setattr(LimitStep.__table__, "engine", engines.ReplacingMergeTree(order_by=LimitStep.__primary_key__))
except Exception:
    pass
...
try:
    ...
    LimitStep.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(LimitStep.__primary_key__),
            "order_by": ",".join(LimitStep.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    LimitStep.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": LimitStep.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    LimitStep.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": LimitStep.__primary_key__,
        }
    )
except Exception:
    pass
