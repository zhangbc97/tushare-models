...
class MarginSecs(Base):
    ...
    __api_info_title__: ClassVar[str] = "融资融券标的(盘前)"
    ...
    __api_params__: ClassVar[Dict[str, Any]] = {
        ...
        "trade_date": {"type": "String", "required": False, "description": "交易日"},
...
try:
    ...
    setattr(MarginSecs.__table__, "engine", engines.ReplacingMergeTree(order_by=MarginSecs.__primary_key__))
except Exception:
    pass
...
try:
    ...
    MarginSecs.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(MarginSecs.__primary_key__),
            "order_by": ",".join(MarginSecs.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    MarginSecs.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": MarginSecs.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    MarginSecs.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": MarginSecs.__primary_key__,
        }
    )
except Exception:
    pass
