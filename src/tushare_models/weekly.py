...
try:
    ...
    setattr(Weekly.__table__, "engine", engines.ReplacingMergeTree(order_by=Weekly.__primary_key__))
except Exception:
    pass
...
try:
    ...
    Weekly.__table__.dialect_options["starrocks"].update(  # type: ignore
        {
            "primary_key": ",".join(Weekly.__primary_key__),
            "order_by": ",".join(Weekly.__primary_key__),
        }
    )
except Exception:
    pass
...
try:
    ...
    Weekly.__table__.dialect_options["databend"].update(  # type: ignore
        {
            "cluster_by": Weekly.__primary_key__,
        }
    )
except Exception:
    pass
...
# Doris引擎配置
try:
    Weekly.__table__.dialect_options["doris"].update(  # type: ignore
        {
            "unique_key": Weekly.__primary_key__,
        }
    )
except Exception:
    pass
